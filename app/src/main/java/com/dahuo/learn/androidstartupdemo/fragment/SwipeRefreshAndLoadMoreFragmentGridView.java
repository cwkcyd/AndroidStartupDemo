...
public class SwipeRefreshAndLoadMoreFragmentGridView extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.frag_swipe_refresh_gridview, null);
                ...
                mSwipeRefreshLayout.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (mAdapter.getItemCount() > 100) {
                            ...
                            //mLayoutManager.getSpanSizeLookup().invalidateSpanIndexCache();
                            //将footer view remove，因为占用了空间
    ...
    public static class SimpleStringRecyclerViewAdapter
        ...
        public ItemViewHolder onCreateItemViewHolder(ViewGroup parent, int viewType) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    int itemPosition = SwipeRefreshAndLoadMoreFragmentGridView.mRecyclerView.getChildAdapterPosition(v);
                    remove(itemPosition);
